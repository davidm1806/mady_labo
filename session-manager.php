...
if (empty($_COOKIE['info'])) {
    ...
    visiteur_page_save($ip_adress, $pays, $ville, $session_id, '::0',$url, 0, $conn);
    ...
    $id = $visiteur_id[0];
    visite_page_update_vu($id, $url, $conn);
    //var_dump($session_id);
}



function visite_page_update_vu($id, $url, $conn)
{
    return $conn->query("update visiteur_page set nbre_vue= nbre_vue +1 where visiteur_id='$id' and url='$url'");
